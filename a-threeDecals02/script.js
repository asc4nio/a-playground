    ...
    window.addEventListener('pointermove', (event) => {
        ...
        if (draggin) {
            if (canShoot) {
                ...
                canShoot = false; // Set the canShoot to false to indicate that the function has been executed

                setTimeout(function () {
                    canShoot = true; // Set the canShoot to true after the specified time has passed
